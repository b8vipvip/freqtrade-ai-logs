...
class MultiCoin_AI_Strategy_20260529_102010_manual_v001(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        macd_cross_momentum_guard = (
            (dataframe["ema_50"] > dataframe["ema_50"].shift(12) * 0.998) &
            (dataframe["volume"] > dataframe["volume_mean_20"] * 1.82)
        )
