...
class MultiCoin_AI_Strategy_20260529_040545_v029(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if "ema_50_1h" not in dataframe.columns:
            dataframe["ema_50_1h"] = dataframe["ema_50"]
        if "ema_200_1h" not in dataframe.columns:
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if pair.startswith("BTC/"):
            ...
            long_condition = long_condition & btc_filter
